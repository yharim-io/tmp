...
from clipvl.layer.clipvl import ClipVLModel, ClipVLPrefix, MappingType
...
def train_text_image(
	...
	if prefix_only:
		clipvl_model = ClipVLPrefix(mapping_type=mapping_type)
		if Cfg.is_master:
	...
	optimizer = AdamW(clipvl_model.parameters(), lr=lr)
	...
	for epoch in range(start_epoch, epochs + start_epoch):
		...
		if Cfg.is_master:
			...
			progress.close()
			torch.save(
				clipvl_model.module.state_dict(),
