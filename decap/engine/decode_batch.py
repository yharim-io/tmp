...
from decap.engine.decode import calc_text_features
...
def decode_batch(
	...
	emb_cat = decap_model.mlp(clip_features).reshape(batch_size, 1, -1)
	...
	for _ in range(entry_length):
		...
		next_token_embed = decap_model.gpt2.embed(next_token)
...
def image_to_text_batch(
	...
	return decode_batch(tokenizer, decap_model, prefix_embedding)